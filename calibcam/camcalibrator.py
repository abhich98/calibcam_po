...
from calibcam.single_camcalibrator import calibrate_single_camera
...
class CamCalibrator:
    ...
    def perform_multi_calibration(self):
        ...
        if self.opts['debug']:
            ...
            test_objective_function(self.model, calibs_multi, vars_free, args, corners, self.board_params, individual_poses=True)
        ...
        if self.opts['debug']:
            ...
            test_objective_function(self.model, calibs_fit, min_result.x, args, corners, self.board_params, individual_poses=True)
        ...
        if self.opts["optimize_board_poses"]:
            ...
            if self.opts['debug']:
                ...
                test_objective_function(self.model, calibs_fit, vars_free, args, corners, self.board_params, individual_poses=True)
        ...
        test_objective_function(self.model, calibs_test, min_result.x, args, corners, self.board_params, individual_poses=True)
